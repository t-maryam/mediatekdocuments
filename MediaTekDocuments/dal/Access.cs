...
namespace MediaTekDocuments.dal
{
    ...
    public class Access
    {
        ...
        public List<CommandeDocument> GetCommandesLivre(string idLivreDvd)
        {
            ...
            List<CommandeDocument> lesCommandes = TraitementRecup<CommandeDocument>(GET, "commandelivre/" + jsonIdLivreDvd, null);
            return lesCommandes;
        }
        ...
        public bool CreerCommandeLivre(CommandeDocument commande)
        {
            ...
            try
            {
                List<CommandeDocument> liste = TraitementRecup<CommandeDocument>(POST, "commandelivre", "champs=" + jsonCommande);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        public bool ModifierSuiviCommande(CommandeDocument commande)
        {
            ...
            try
            {
                List<CommandeDocument> liste = TraitementRecup<CommandeDocument>(PUT, "commandelivre", "champs=" + jsonCommande);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        public bool SupprimerCommandeLivre(string id)
        {
            ...
            try
            {
                List<CommandeDocument> liste = TraitementRecup<CommandeDocument>(DELETE, "commandelivre", "champs=" + jsonId);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        public List<Abonnement> GetCommandesRevue(string idRevue)
        {
            if (idRevue.Equals(""))
            {
                return TraitementRecup<Abonnement>(GET, "commanderevue", null);
            }
        ...
        /// <summary>
        /// Crée une commande de revue (abonnement) dans la BDD
        /// </summary>
        public bool CreerCommandeRevue(Abonnement abonnement)
        {
            ...
            try
            {
                List<Abonnement> liste = TraitementRecup<Abonnement>(POST, "commanderevue", "champs=" + jsonAbonnement);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Modifie la date de fin d'un abonnement (renouvellement)
        /// </summary>
        public bool RenouvelerAbonnement(Abonnement abonnement)
        {
            ...
            try
            {
                List<Abonnement> liste = TraitementRecup<Abonnement>(PUT, "commanderevue", "champs=" + jsonAbonnement);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        public bool SupprimerCommandeRevue(string id)
        {
            ...
            try
            {
                List<Abonnement> liste = TraitementRecup<Abonnement>(DELETE, "commanderevue", "champs=" + jsonId);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        {
            List<Abonnement> tous = TraitementRecup<Abonnement>(GET, "commanderevue", null);
